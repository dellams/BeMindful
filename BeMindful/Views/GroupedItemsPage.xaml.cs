...
namespace BeMindful
{
    ...
    /// </summary>
    public sealed partial class GroupedItemsPage : BeMindful.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var groups = DataSource.StorageProvider.GetAllPlaceTypes();
        ...
        void Header_Click(object sender, RoutedEventArgs e)
        {
            ...
            this.Frame.Navigate(typeof(GroupDetailPage), ((IPlaceType)group).Id);
