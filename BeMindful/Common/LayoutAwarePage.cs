...
namespace BeMindful.Common
{
    ...
    public class LayoutAwarePage : Page
    {
        ...
        public void StartLayoutUpdates(object sender, RoutedEventArgs e)
        {
            ...
            string test = DetermineVisualState(ApplicationView.Value);
        ...
        {
            //TODO: May move all logic to this base page if it repeats for each page...

            if (DataSource.SelectedItem != null)
                navigationParameter = DataSource.SelectedItem;
            else
                DataSource.SelectedItem = (IBaseModel)navigationParameter;
        ...
        protected dynamic GetSelectedItemParentItems(object selectedItem)
        {
             dynamic items = null;

             if (selectedItem is IPlace)
                items = ((selectedItem as IPlace).Parent).Places;
            
             else if (selectedItem is IPerson) //TODO: Dont want to do this for viewing personDetails
                 items = DataSource.People.GetPeopleForPersonType((selectedItem as IPerson).PersonType, (PeopleSortBy)DataSource.LastSortBy, DataSource.LastSortDir);
                 //items = DataSource.GetPeopleForPersonType((selectedItem as PersonViewModel).PersonType, (PeopleSortBy)DataSource.LastSortBy, DataSource.LastSortDir);
